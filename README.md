...
Alias note: `site`, `website`, `showcase`, and `governance-demo` resolve to `web-app` for teams that name the same public proof by surface or governance demo outcome instead of stack.
